...
//     } 
//   } else {
//     const articles = filterArticle.childNodes;
//     listTitles.innerHTML = '';
//     // console.dir(articles.outerHTML);
//     // console.dir(articles.childNodes);
//     for (let article of articles) {
//       const articleId = '#' + article.getAttribute('id');
//       const articleTitle = article.querySelector('h3.post-title').textContent;
//       const link = `<li><a href=${articleId}><span> ${articleTitle} </span></a></li>`;
...
//     if (activeClass) {
//       active.insertAdjacentHTML('beforeend', element.outerHTML);
//     }
//   }
